...
function BestPriceGuarantee(){
    ...
    },
    {
     ...
     return (
        <>
        <div id="bg">
        <h2>Best price guarantee <Link to="/bestpriceguarantee">SEE MORE</Link></h2>
        <div id="best-price-guarantee">
         {bestprice && bestprice.map((item,idx)=>{
              return <div id="guarantee-card" key={idx}>
                 <img src={item.image} alt="guaranteeimage" id="guarantee-img"/>
                 <h5>{item.tag}</h5>
